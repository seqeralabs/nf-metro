...
case "$subagent_type" in
  fix-issue-investigator|fix-issue-diagnostician|fix-issue-reviewer|fix-issue-simplifier|fix-issue-verifier|fix-issue-gate-specialist|fix-issue-renderer|fix-issue-merge-assessor|fix-issue-visual-reviewer)
    if [ -n "$model" ]; then
