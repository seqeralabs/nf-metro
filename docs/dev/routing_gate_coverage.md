...
**2277/3213** gates fully exercised (both/all arms hit by some fixture); **936** gates have at least one un-exercised arm.
...
| 3707 | `if current.keys() != snapshot.geometry.keys():` | `->L3708` |  |
| 3722 | `if current[key] != state:` | `->L3723` |  |
| 3753 | `or exit_turn_plan.system_id in skip_system_ids` | `->L3755` |  |
| 3759 | `station_id not in graph.stations` | `->L3762` |  |
| 3760 | `or lane.line_id not in graph.station_lines(station_id)` | `->L3762` |  |
| 3768 | `if (station_id, lane.line_id) not in station_offsets or (` | `->L3775` |  |
| 3783 | `if len(transition_routes) != 1:` | `->L3784` |  |
| 3821 | `route.exit_lane_transition_plan_id != str(exit_turn_plan.id)` | `->L3826` |  |
| 3822 | `or route.offset_regime is not OffsetRegime.BAKED` | `->L3826` |  |
| 3823 | `or route.points != expected_route.points` | `->L3826` |  |
| 3824 | `or route.curve_radii != expected_route.curve_radii` | `->L3826` |  |
| 3842 | `if not _fixed_axis_matches_plan(` | `->L3847` |  |
| 3853 | `if any(` | `->L3862` |  |
| 3870 | `if len(member_routes) != 1:` | `->L3871` |  |
| 3878 | `if route.exit_turn_family_id != assignment.planned_family_id.value:` | `->L3879` |  |
| 3886 | `if route.exit_turn_axis_id is not None:` | `->L3887` |  |
| 3895 | `if (` | `->L3909` |  |
| 3917 | `route.exit_turn_axis_id != str(assignment.axis_id)` | `->L3920` |  |
| 3918 | `or route.exit_turn_segment_rank is None` | `->L3920` |  |
| 3931 | `if (` | `->L3953` |  |
