...
**2264/3198** gates fully exercised (both/all arms hit by some fixture); **934** gates have at least one un-exercised arm.
...
| 5652 | `if route.curve_radii is None:` | `->L5653` |  |
| 5666 | `if not members:` | `->L5667` |  |
