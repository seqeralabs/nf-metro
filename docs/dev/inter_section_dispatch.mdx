...
| 5   | `TB_BOTTOM_EXIT_AROUND_STACK`         | `TB bottom exit around stack`           | A TB/BT trailing-exit run, or a junction branch continuing one down its column, crosses sections stacked between source and target. | `_route_around_stack` diverts through a clear gap.                                                           |
