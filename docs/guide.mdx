...
import MetroExample from "../../components/MetroExample.astro";
import minimalMmd from "@examples/guide/01_minimal.mmd?raw";
import sectionsMmd from "@examples/guide/02_sections.mmd?raw";
import fanOutMmd from "@examples/guide/03_fan_out.mmd?raw";
import fanInMergeMmd from "@examples/guide/03b_fan_in_merge.mmd?raw";
import directionsMmd from "@examples/guide/04_directions.mmd?raw";
import fileIconsMmd from "@examples/guide/05_file_icons.mmd?raw";
import filesIconMmd from "@examples/guide/05c_files_icon.mmd?raw";
import folderIconMmd from "@examples/guide/05d_folder_icon.mmd?raw";
import bannerLabelsMmd from "@examples/guide/05f_banner_labels.mmd?raw";
import markerStylesMmd from "@examples/marker_styles.mmd?raw";
import withoutHiddenMmd from "@examples/guide/06a_without_hidden.mmd?raw";
import withHiddenMmd from "@examples/guide/06b_with_hidden.mmd?raw";
import rnaseqAutoMmd from "@examples/rnaseq_auto.mmd?raw";
import variantbenchmarkingAutoMmd from "@examples/variantbenchmarking_auto.mmd?raw";
...
<MetroExample src={minimalMmd} title="examples/guide/01_minimal.mmd" />
...
<MetroExample src={sectionsMmd} title="examples/guide/02_sections.mmd" />
...
<MetroExample src={fanOutMmd} title="examples/guide/03_fan_out.mmd" />
...
<MetroExample src={fanInMergeMmd} title="examples/guide/03b_fan_in_merge.mmd" />
...
<MetroExample src={directionsMmd} title="examples/guide/04_directions.mmd" />
...
<MetroExample src={fileIconsMmd} title="examples/guide/05_file_icons.mmd" />
...
<MetroExample src={filesIconMmd} showCode={false} />
...
<MetroExample src={folderIconMmd} showCode={false} />
...
<MetroExample src={bannerLabelsMmd} showCode={false} />
...
<MetroExample src={markerStylesMmd} title="examples/marker_styles.mmd" />
...
<MetroExample src={withoutHiddenMmd} title="examples/guide/06a_without_hidden.mmd" />
...
<MetroExample src={withHiddenMmd} showCode={false} />
...
<MetroExample src={rnaseqAutoMmd} showCode={false} />
...
<MetroExample src={variantbenchmarkingAutoMmd} showCode={false} />
