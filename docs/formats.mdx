...
<img
  src="../assets/formats_animated.svg"
  alt="The nf-core/rnaseq metro map as an animated SVG"
  loading="lazy"
  style="width: 100%; border-radius: 6px"
/>

_`--animate --embed-font`, in a plain `<img>`: 315&nbsp;KB. Its colours follow your system theme, where every raster below is baked to one._
...
<img
  src="../assets/formats_still.png"
  alt="The nf-core/rnaseq metro map as a PNG"
  loading="lazy"
  style="width: 100%; border-radius: 6px"
/>

_The same map at `--scale 1`: 1799&times;696, 138&nbsp;KB._
...
<Tabs>
  <TabItem label="GIF">
    <img
      src="../assets/formats_loop.gif"
      alt="The nf-core/rnaseq metro map as a looping GIF"
      loading="lazy"
      style="width: 100%; border-radius: 6px"
    />

    _256-colour palette, 337&nbsp;KB. Animates inside an `<img>`._

  </TabItem>
  <TabItem label="WebP">
    <img
      src="../assets/formats_loop.webp"
      alt="The nf-core/rnaseq metro map as a looping WebP"
      loading="lazy"
      style="width: 100%; border-radius: 6px"
    />

    _Full 24-bit colour, 395&nbsp;KB. Animates inside an `<img>`._
  ...
  <TabItem label="MP4">
    ...
    _H.264, 191&nbsp;KB. Needs a `<video>` element._
  ...
  <TabItem label="WebM">
    <video
      ...
      playsinline
      style="width: 100%; border-radius: 6px"
      src="../assets/formats_loop.webm"
    >
      Your browser can't play the embedded video.
      <a href="../assets/formats_loop.webm">Download it here</a>.
    </video>

    _VP9, 213&nbsp;KB. Needs a `<video>` element._
