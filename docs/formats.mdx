...
<Metro src="examples/rnaseq_sections.mmd" mmd={false} animate clean />

_`--animate`, inlined into the page. Its colours follow your system theme, where every raster below is baked to one._
...
<Metro
  src="examples/rnaseq_sections.mmd"
  mmd={false}
  format="png"
  scale={1}
  clean
...
_The same map at `--scale 1`: 1799&times;696._
...
<Tabs>
  <TabItem label="GIF">
    <Metro src="examples/rnaseq_sections.mmd" mmd={false} format="gif" duration={12} fps={20} clean />

    _256-colour palette. Animates inside an `<img>`._

  </TabItem>
  <TabItem label="WebP">
    <Metro src="examples/rnaseq_sections.mmd" mmd={false} format="webp" duration={12} fps={20} clean />

    _Full 24-bit colour. Animates inside an `<img>`._

  </TabItem>
  <TabItem label="MP4">
    <Metro src="examples/rnaseq_sections.mmd" mmd={false} format="mp4" duration={12} fps={20} clean />

    _H.264. Needs a `<video>` element._

  </TabItem>
  <TabItem label="WebM">
    <Metro src="examples/rnaseq_sections.mmd" mmd={false} format="webm" duration={12} fps={20} clean />

    _VP9. Needs a `<video>` element._
