...
The **Gallery** and **nf-core pipelines** pages, plus all rendered example SVGs,
are generated by `python scripts/build_gallery.py` (writes Markdown into
`docs/{gallery,pipelines}/` and SVGs into `docs/assets/renders/` — both
git-ignored). The interactive **playground** is static files under
